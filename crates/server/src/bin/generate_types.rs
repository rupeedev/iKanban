...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        db::models::project::ProjectStatus::decl(),
        ...
        db::models::team::TeamProject::decl(),
        db::models::team::CreateTeam::decl(),
        db::models::team::UpdateTeam::decl(),
        db::models::team::TeamProjectAssignment::decl(),
        db::models::team_member::TeamMemberRole::decl(),
        db::models::team_member::TeamInvitationStatus::decl(),
        ...
        db::models::member_project_access::MemberProjectAccess::decl(),
        db::models::member_project_access::SetMemberProjectAccess::decl(),
        ...
        db::models::github_connection::UpdateGitHubConnection::decl(),
        db::models::github_connection::LinkGitHubRepository::decl(),
        db::models::github_connection::GitHubConnectionWithRepos::decl(),
        db::models::github_connection::GitHubRepoSyncConfig::decl(),
        db::models::github_connection::CreateRepoSyncConfig::decl(),
        db::models::github_connection::ConfigureMultiFolderSync::decl(),
        ...
        server::routes::teams::GitHubRepoInfo::decl(),
        server::routes::teams::ConfigureSyncRequest::decl(),
        ...
        db::models::document::CreateDocumentFolder::decl(),
        db::models::document::UpdateDocumentFolder::decl(),
        db::models::document::CreateDocument::decl(),
        db::models::document::UpdateDocument::decl(),
        server::routes::documents::ListDocumentsQuery::decl(),
        db::models::inbox::InboxNotificationType::decl(),
        db::models::inbox::InboxItem::decl(),
        db::models::inbox::CreateInboxItem::decl(),
        db::models::inbox::InboxSummary::decl(),
        ...
        db::models::task_document_link::TaskDocumentLink::decl(),
        db::models::task_document_link::LinkDocumentsRequest::decl(),
        db::models::task_document_link::LinkedDocument::decl(),
        ...
        server::routes::oauth::GitHubAuthorizeResponse::decl(),
