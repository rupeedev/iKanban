...
pub fn router(deployment: &DeploymentImpl) -> Router<DeploymentImpl> {
    Router::new()
        // Google Drive routes
        .route("/storage/google-drive/auth-url", post(google_drive::get_auth_url))
        .route("/storage/google-drive/callback", get(google_drive::oauth_callback))
        .route("/storage/google-drive/disconnect", post(google_drive::disconnect))
        .route("/storage/google-drive/status", get(google_drive::get_status))
