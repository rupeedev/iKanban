...
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_execution_processes_session_run_reason_created" ON "execution_processes" ("created_at","run_reason","session_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_execution_processes_session_status_run_reason" ON "execution_processes" ("run_reason","session_id","status");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "idx_sessions_workspace_id_created_at" ON "sessions" ("created_at","workspace_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_sessions_workspace_id" ON "sessions" ("workspace_id");--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "idx_tasks_team_issue_unique" ON "tasks" ("issue_number","team_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_tasks_team_issue_number" ON "tasks" ("issue_number","team_id");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "idx_tasks_project_created_at" ON "tasks" ("created_at","project_id");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "idx_task_attempts_task_id_created_at" ON "workspaces" ("created_at","task_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_scratch_created_at" ON "scratch" ("created_at");--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "execution_processes" ADD CONSTRAINT "execution_processes_session_id_sessions_id_fk" FOREIGN KEY ("session_id") REFERENCES "public"."sessions"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "workspaces" ADD CONSTRAINT "workspaces_task_id_tasks_id_fk" FOREIGN KEY ("task_id") REFERENCES "public"."tasks"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
