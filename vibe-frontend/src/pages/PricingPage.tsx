...
const plans: PricingPlan[] = [
  {
    name: 'Starter',
    description: 'Perfect for small teams starting with AI task management',
    monthlyPrice: 19,
    yearlyPrice: 16,
    icon: 'starter',
    isPopular: false,
    ctaText: 'Sign Up & Get Started',
    ctaLink: '/sign-up',
    limits: {
      teams: '2 teams',
      projects: '5 projects',
    ...
    features: [
      { text: 'Basic task tracking and kanban boards', included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'Unlimited teams & projects', included: true },
      { text: 'SSO/SAML authentication', included: true },
      { text: 'Advanced AI recommendations', included: true },
      { text: 'Unlimited AI task updates', included: true },
