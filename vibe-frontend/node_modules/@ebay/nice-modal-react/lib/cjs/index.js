...
exports.bootstrapDialog = exports.muiDialogV5 = exports.muiDialog = exports.antdDrawerV5 = exports.antdDrawer = exports.antdModalV5 = exports.antdModal = exports.ModalHolder = exports.ModalDef = exports.Provider = exports.unregister = exports.register = exports.create = exports.useModal = exports.remove = exports.hide = exports.show = exports.reducer = exports.NiceModalContext = void 0;
...
var initialState = {};
exports.NiceModalContext = react_1.default.createContext(initialState);
...
function useModal(modal, args) {
    var modals = react_1.useContext(exports.NiceModalContext);
...
var InnerContextProvider = function (_a) {
    ...
    var modals = arr[0];
    dispatch = arr[1];
    return (react_1.default.createElement(exports.NiceModalContext.Provider, { value: modals },
        children,
...
var Provider = function (_a) {
    ...
    return (react_1.default.createElement(exports.NiceModalContext.Provider, { value: givenModals },
        children,
        react_1.default.createElement(NiceModalPlaceholder, null)));
};
...
var ModalHolder = function (_a) {
    ...
    var mid = react_1.useMemo(function () { return getUid(); }, []);
    ...
    handler.show = react_1.useCallback(function (args) { return show(mid, args); }, [mid]);
    handler.hide = react_1.useCallback(function () { return hide(mid); }, [mid]);
    return react_1.default.createElement(ModalComp, __assign({ id: mid }, restProps));
};
exports.ModalHolder = ModalHolder;
...
var NiceModal = {
    ...
    ModalHolder: exports.ModalHolder,
    NiceModalContext: exports.NiceModalContext,
