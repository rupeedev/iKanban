...
function Dialog({ ...props }) {
    return _jsx(Root, { "data-slot": 'dialog', ...props });
}
/**
...
function DialogTrigger({ ...props }) {
    return _jsx(Trigger, { "data-slot": 'dialog-trigger', ...props });
}
/**
...
function DialogPortal({ ...props }) {
    return _jsx(Portal, { "data-slot": 'dialog-portal', ...props });
}
/**
...
function DialogClose({ ...props }) {
    return _jsx(Close, { "data-slot": 'dialog-close', ...props });
}
/**
...
function DialogOverlay({ className, ...props }) {
    return (_jsx(Overlay, { "data-slot": 'dialog-overlay', className: cn('data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 z-50 bg-black/50', className), ...props }));
}
/**
...
function DialogTitle({ className, ...props }) {
    return _jsx(Title, { "data-slot": 'dialog-title', className: cn('text-lg leading-none font-semibold', className), ...props });
}
/**
...
function DialogDescription({ className, ...props }) {
    return (_jsx(Description, { "data-slot": 'dialog-description', className: cn('text-muted-foreground text-sm', className), ...props }));
}
