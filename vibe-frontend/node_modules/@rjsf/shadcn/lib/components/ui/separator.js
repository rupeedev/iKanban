...
function Separator({ className, orientation = 'horizontal', decorative = true, ...props }) {
    return (_jsx(Root, { "data-slot": 'separator', decorative: decorative, orientation: orientation, className: cn('bg-border shrink-0 data-[orientation=horizontal]:h-px data-[orientation=horizontal]:w-full data-[orientation=vertical]:h-full data-[orientation=vertical]:w-px', className), ...props }));
}
export { Separator };
