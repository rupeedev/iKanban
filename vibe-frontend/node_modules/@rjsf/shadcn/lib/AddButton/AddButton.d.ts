 ...
 */
export default function AddButton<T = any, S extends StrictRJSFSchema = RJSFSchema, F extends FormContextType = any>({ uiSchema, registry, className, ...props }: IconButtonProps<T, S, F>): import("react/jsx-runtime").JSX.Element;
