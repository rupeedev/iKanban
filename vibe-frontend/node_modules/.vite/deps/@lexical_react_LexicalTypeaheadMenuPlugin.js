import {
  mergeRegister
} from "./chunk-WMI5WA4N.js";
import {
  useLexicalComposerContext
} from "./chunk-RZ75UBPE.js";
import {
  $getSelection,
  $isRangeSelection,
  $isTextNode,
...
// ../node_modules/.pnpm/@lexical+react@0.36.2_react-dom@18.3.1_react@18.3.1__react@18.3.1_yjs@13.6.27/node_modules/@lexical/react/LexicalTypeaheadMenuPlugin.dev.mjs
...
var SCROLL_TYPEAHEAD_OPTION_INTO_VIEW_COMMAND$1 = createCommand("SCROLL_TYPEAHEAD_OPTION_INTO_VIEW_COMMAND");
...
function useMenuAnchorRef(resolution, setResolution, className, parent = CAN_USE_DOM ? document.body : void 0, shouldIncludePageYOffset__EXPERIMENTAL = true) {
  ...
  const anchorElementRef = (0, import_react.useRef)(initialAnchorElement);
...
function useBasicTypeaheadTriggerMatch(trigger, {
  ...
  return (0, import_react.useCallback)((text) => {
...
function LexicalTypeaheadMenuPlugin({
  ...
  const closeTypeahead = (0, import_react.useCallback)(() => {
    setResolution(null);
    if (onClose != null && resolution !== null) {
      onClose();
    }
  }, [onClose, resolution]);
  const openTypeahead = (0, import_react.useCallback)((res) => {
    setResolution(res);
  ...
  (0, import_react.useEffect)(() => editor.registerEditableListener((isEditable) => {
    if (!isEditable) {
      closeTypeahead();
    }
  }), [editor, closeTypeahead]);
  return resolution === null || editor === null || anchorElementRef.current === null ? null : (0, import_jsx_runtime.jsx)(LexicalMenu, {
...
//# sourceMappingURL=@lexical_react_LexicalTypeaheadMenuPlugin.js.map
