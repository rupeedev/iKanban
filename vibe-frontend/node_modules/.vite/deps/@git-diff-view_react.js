...
import {
  ...
  versions
} from "./chunk-ISULB72G.js";
import "./chunk-4XTBART3.js";
import "./chunk-E62GZILC.js";
import "./chunk-RZDOWMZ5.js";
import {
  require_react
...
// ../node_modules/.pnpm/@git-diff-view+react@0.0.30_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/@git-diff-view/react/dist/esm/index.mjs
...
// ../node_modules/.pnpm/reactivity-store@0.3.11_react@18.3.1/node_modules/reactivity-store/dist/esm/index.mjs
...
var Controller = class {
  constructor(_getState, _compare, _lifeCycle, _list, _namespace, _onUpdate) {
    ...
    if (this._namespace !== InternalNameSpace.$$__persist__$$ && this._namespace !== InternalNameSpace.$$__subscribe__$$ && this._namespace !== InternalNameSpace.$$__redux_dev_tool__$$) {
      this._list = _list;
      this._list.add(this);
    }
    if (true) {
...
var createHook = (reactiveState, readonlyState, initialState, lifeCycle, deepSelector = true, stableSelector = false, stableCompare = true, namespace, actions = void 0) => {
  ...
  const generateUseHook = (type) => {
    ...
    function useReactiveHookWithSelector(selector, compare) {
      ...
      const ControllerInstance = (0, import_react.useMemo)(() => new Controller(() => selectorRef(reactiveState), memoCompare, lifeCycle, controllerList, namespace, getSelected), []);
