...
var It = K(
  () => {
    const t = U(), e = U(), n = C(0), o = U(), r = C(0), s = U(), i = U(), l = C(0), u = C(0), d = C(0), m = C(0), S = U(), h = U(), T = C(false), w = C(false), R = C(false);
    return F(
      x(
        t,
        k(({ scrollTop: g }) => g)
...
function Ho(t, e) {
  ...
  for (const o of e) {
    ...
    for (const { end: m, start: S, value: h } of l)
      u ? (r >= S || s === h) && (t = Le(t, S)) : (d = h !== s, u = true), m > r && r >= S && h !== s && (t = yt(t, r + 1, h));
    d && (t = yt(t, i, s));
  }
  return [t, n];
}
...
var me = K(
  ([
    ...
    function I() {
      g && (g(), g = null), a && (a(), a = null), f && (clearTimeout(f), f = null), D(u, false);
    }
    return F(
      x(
        T,
...
function Ye(t, e, n) {
  ...
  const S = import_react.default.forwardRef((f, a) => {
    ...
    const c = n;
    return (0, import_jsx_runtime.jsx)(l.Provider, { value: y, children: n ? (0, import_jsx_runtime.jsx)(c, { ...er([...o, ...r, ...i], b), children: I }) : I });
  }), h = (f) => {
...
function eo(t, e, n, o = Qt, r, s) {
  const i = import_react.default.useRef(null), l = import_react.default.useRef(null), u = import_react.default.useRef(null), d = import_react.default.useCallback(
    (h) => {
      let T, w, R;
      const g = h.target;
      if (nr(g) || ke(g)) {
      ...
      h.suppressFlushSync ? f() : import_react_dom.default.flushSync(f), l.current !== null && (R === l.current || R <= 0 || R === T - w) && (l.current = null, e(true), u.current && (clearTimeout(u.current), u.current = null));
    },
    [t, e, s]
  );
...
function Je({ useEmitter: t, useEmitterValue: e, usePublisher: n }) {
  return import_react.default.memo(function({ children: s, style: i, context: l, ...u }) {
...
var yr = import_react.default.memo(function() {
  ...
  const z = (n ? e.topItems : []).reduce((B, W) => B + W.size, 0), c = e.offsetTop + I + w - z, p = e.offsetBottom, v = c > 0 ? (0, import_jsx_runtime.jsx)(f, { context: y, height: c }, "padding-top") : null, O = p > 0 ? (0, import_jsx_runtime.jsx)(f, { context: y, height: p }, "padding-bottom") : null;
...
var Hr = import_react.default.memo(function(e) {
  ...
  return (0, import_jsx_runtime.jsx)(S, { ...e, ...Q(S, u), children: (0, import_jsx_runtime.jsx)(h, { children: (0, import_jsx_runtime.jsxs)(T, { style: { borderSpacing: 0, overflowAnchor: "none" }, ...Q(T, u), children: [
    g,
